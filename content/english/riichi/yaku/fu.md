...
If the hand is viewed as waiting on the ryanmen {{< t 23m >}}, then it qualifies for pinfu. If,
however, the hand is viewed as waiting on the kanchan {{< t 35m >}}, then it does not. It must be
scored as pinfu because that is worth more points.
...
A hand with 1 han and 110 fu is an exceptionally rare hand. Its requirements are particularly
limited, because the hand must be composed of all, not just some, the conditions in the following
example.
...
A hand with 2 han and 110 fu is also possible, as in the following for the East player in the East
round:
...
to have a significant influence on the total. In that case, it's better to simply count the fu
properly.

"Almost always" means that there are a few exceptions which may raise the fu past the shortcut
value. In particular, look for these elements in the hand's composition:
